...
export default function AdminCreateResource() {
  ...
  const handleFileSelect = (event) => {
    ...
    // Check for both .xlsx and .xls file types
    ...
    if (!validFileTypes.includes(file.type)) {
      alert("Invalid file type. Please select a valid Excel (.xlsx or .xls) file.");
      return;
    }
  ...
  return (
   <div>
    <div>
      <h2 style={{textAlign:"center",color:"white",marginTop:"10px"}}>Create Employees</h2>
      </div>
     <div
      className="container-fluid  d-flex justify-content-center align-items-center flex-row"
      ...
      >
        ...
        {results.length === 0 ? (
          <>
            ...
            {uploadConfirmed ? (
              ...
              <>
                ...
                />
                <h6 style={{ color: "black", alignContent:"center", textAlign:"center",fontSize:"17px"}}>
              Please upload only .xlsx and .xls files Only
            </h6>
                {/* <button
          ...
          <div>
            ...
            <button
              className="btn btn-secondary mt-3 mb-10"
